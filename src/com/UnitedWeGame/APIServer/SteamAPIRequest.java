                                        ...
                                        switch (onlineStatus) {
                                                ...
                                                try {
                                                    ...
                                                    try {
                                                        ...
                                                        if (gameID == -1) {
                                                            ...
                                                            dbcu.insertGameIntoDb("Online", STEAM, imageUrl, new HashMap<>());
                                                            gameID = dbcu.getGameID("Online", STEAM);
                                                        }
                                                        break;
                                                    }
                                                    ...
                                                    if (StringUtils.isEmpty(gameName)) {
                                                        ...
                                                        if (gameID == -1) {
                                                            ...
                                                            dbcu.insertGameIntoDb(appName, STEAM, imageUrl, new IgdbAPIService().getGameData(appName));
                                                            gameID = dbcu.getGameID(appName, STEAM);
                                                    ...
                                                    if (gameID == -1) {
                                                        ...
                                                        dbcu.insertGameIntoDb("Unknown", STEAM, imageUrl, new HashMap<>());
                                                        gameID = dbcu.getGameID("Unknown", STEAM);
                                                    }
                                                }
                                                break;
                                            case "2":
                                                ...
                                                if (gameID == -1) {
                                                    ...
                                                    dbcu.insertGameIntoDb("Busy", STEAM, imageUrl, new HashMap<>());
                                                    gameID = dbcu.getGameID("Busy", STEAM);
                                                }
                                                break;
                                            case "3":
                                                ...
                                                if (gameID == -1) {
                                                    ...
                                                    dbcu.insertGameIntoDb("Away", STEAM, imageUrl, new HashMap<>());
                                                    gameID = dbcu.getGameID("Away", STEAM);
                                                }
                                                break;
                                            case "4":
                                                ...
                                                if (gameID == -1) {
                                                    ...
                                                    dbcu.insertGameIntoDb("Snooze", STEAM, imageUrl, new HashMap<>());
                                                    gameID = dbcu.getGameID("Snooze", STEAM);
                                                }
                                                break;
                                            case "5":
                                                ...
                                                if (gameID == -1) {
                                                    ...
                                                    dbcu.insertGameIntoDb("Looking To Trade", STEAM, imageUrl, new HashMap<>());
                                                    gameID = dbcu.getGameID("Looking To Trade", STEAM);
                                                }
                                                break;
                                            case "6":
                                                ...
                                                if (gameID == -1) {
                                                    ...
                                                    dbcu.insertGameIntoDb("Looking To Play", STEAM, imageUrl, new HashMap<>());
                                                    gameID = dbcu.getGameID("Looking To Play", STEAM);
                                                }
                                                break;
                                        }
                ...
                try {
                    ...
                    if (dbcu.getGameID(currentGame.getTitle(), STEAM) == -1) {
                        try {
                            ...
                            dbcu.insertGameIntoDb(currentGame.getTitle(), STEAM, baseImageURL, new IgdbAPIService().getGameData(currentGame.getTitle()));
                            ...
                            dbcu.insertGameIntoDb(currentGame.getTitle(), STEAM, imageURL, new IgdbAPIService().getGameData(currentGame.getTitle()));
                            long gameID = dbcu.getGameID(currentGame.getTitle(), STEAM);
                            dbcu.insertScreenshotsIntoDB(gameID, new IgdbAPIService().getScreenshots(currentGame.getTitle()));
                            gameList.put(game.get("appid").toString(), currentGame.getTitle());
                        }
